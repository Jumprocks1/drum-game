namespace FFMediaToolkit
{
    ...
    public static class FFmpegLoader
    {
        ...
        public static void LoadFFmpeg()
        {
            ...
            if (!isPathSet) throw new Exception("Missing FFmpeg directory");
            ...
            if (!(IsFFmpegGplLicensed ?? false))
                throw new Exception("LGPL version of FFmpeg does not support encoding. Please set Config.FFmpegLocation to v4 of the GPL FFmpeg shared libraries.");
