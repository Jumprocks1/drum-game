...
export default class LogoPage extends PageComponent {
    ...
    InnerRadius = 95 //this.OuterRadius - this.StrokeWidth;
    ...
    Draw() {
        ...
        context.fillStyle = "#2472c8"
        context.beginPath();
        context.arc(0, 0, this.OuterRadius, 0, 2 * Math.PI)
        context.fill()

        context.beginPath();
        context.fillStyle = "#292a2d"
        context.arc(0, 0, this.InnerRadius, 0, 2 * Math.PI)
        context.fill()
